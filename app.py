...
# === Verbinding met Coinbase (API-sleutels via secrets) ===
exchange = ccxt.coinbase({
    "apiKey": st.secrets["apiKey"],   # Zet je API key in secrets.toml
    "secret": st.secrets["secret"],   # Zet je secret in secrets.toml
